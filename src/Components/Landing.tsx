...
export default function Landing() {
  return (
    <div className="relative">
      <img
        className=" object-cover w-full sm:h-screen lg:h-[800px]"
        src={landingImg}
        alt="landingImg"
      />
      ...
      <div className="absolute top-[50%] -translate-y-1/2 -translate-x-1/2 left-[50%]">
        ...
        <div className="text-center mt-10">
          <Button
            variant={"destructive"}
            className="text-[20px] cursor-pointer bg-[#D62828] border-2 rounded-[20px]  border-[#e67e7e] font-medium text-white "
          >
            Explore Products
          </Button>
        </div>
